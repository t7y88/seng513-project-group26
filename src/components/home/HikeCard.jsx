...
export default function HikeCard(hikeData) {
  return (
    <Link
      ...
      className="p-1.5 rounded-2xl bg-white hover:shadow-xl hover:items-150% hover:scale-[1.10] transition-shadow duration-300 shrink-0 max-sm:w-xs max-md:w-1/4 min-md:w-1/3 snap-center scroll-smooth cursor-pointer"
    >
      <h2 className="font-bold text-l px-2 text-gray-800 truncate">
        {hikeData.title}, {hikeData.province}
      </h2>
      ...
      <div className="px-2 pt-0.5">
        ...
        <div className="flex flex-wrap gap-2 items-center justify-center">
          ...
          <span className="inline-block bg-grey-300 rounded-full px-2 text-sm font-semibold text-black">
            {hikeData.distance} {hikeData.distanceUnit} <b>Elev.</b>{" "}
            {hikeData.elevation} {hikeData.elevationUnit}
          </span>
